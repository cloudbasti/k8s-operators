...
const (
	addPodNameLabelAnnotation = "physics-principles.com/add-pod-name-label"
	podNameLabel              = "physics-principles.com/pod-name"
)
...
// +kubebuilder:rbac:groups=core.physics-principles.com,resources=pods,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=core.physics-principles.com,resources=pods/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=core.physics-principles.com,resources=pods/finalizers,verbs=update
